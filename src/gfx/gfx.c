...
Modified: Methusael Murmu

For complete documentation, see:
http://www.nd.edu/~dthain/courses/cse20211/fall2011/gfx

2017 - Added support for non-resizable windows
...
void gfx_open( int width, int height, const char *title, int resizable )
{
	...
	if (resizable == 0) {
		...
		XSetWMNormalHints(gfx_display, gfx_window, hints);
		XFree(hints);
	}
